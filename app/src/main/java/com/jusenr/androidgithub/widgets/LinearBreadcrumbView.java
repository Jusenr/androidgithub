 ...
 */
public class LinearBreadcrumbView extends HorizontalScrollView implements View.OnClickListener {
    ...
    public LinearBreadcrumbView(Context context) {
        super(context);
        init();
    }

    public LinearBreadcrumbView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LinearBreadcrumbView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public static class SavedStateWrapper implements Serializable {
        ...
        public SavedStateWrapper(LinearBreadcrumbView view) {
